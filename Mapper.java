...
public class Mapper extends GUI {
	private static boolean Artpoint;
	...
	protected void onClick(MouseEvent e) {
		...
		if (aStar) {
			...
			if (clicked.distance(closest.location) < MAX_CLICKED_DISTANCE && finish != null) {
				graph.setHighlight(start);
				graph.setHighlight(finish);
			}

			System.out.println(start.toString());
			System.out.println(finish.toString());
			
			Set<Node> s = new HashSet<Node>(graph.nodes.values());
			
			astar a = new astar(start, finish, s);
			...
			graph.aStarHighlight(b);
			graph.setSegHighlights(a.getHighlight());
	...
	public static void setAStar(boolean b) {
		aStar = b;

	}

	public static boolean getAStar() {
		// TODO Auto-generated method stub
		return aStar;
	}

	public static boolean isArtpoint() {
		return Artpoint;
	}

	public static void setArtpoint(boolean artpoint) {
		Artpoint = artpoint;
	}
	...
	protected void Artpoints() {
		...
		ap.initArtPoint(graph.nodes.values());
