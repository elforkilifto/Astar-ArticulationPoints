...
public abstract class GUI {
	...
	protected abstract void Artpoints();
	...
	private void initialise() {
		...
		JButton aStarSearch = new JButton("A*");
		aStarSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				Mapper.setAStar(!Mapper.getAStar());
				redraw();
			}
			});
			
			JButton ArticulationPoint = new JButton("ArticulationPoint");
			ArticulationPoint.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent ev) {
					Artpoints();
					redraw();
				}
		...
		loadquit.add(aStarSearch);
		loadquit.add(ArticulationPoint);
